$(function(){
//  功能1发送ajax请求，获取数据，渲染产品
var categoryid = getSearch('categoryid')||1;
 $.ajax({
  ...
  $.ajax({
    ...
    success:function( info ) {
      ...
      var base = {
        ...
        extraStr: '&categoryid=' + categoryid    // 默认为空，额外需要传在 url 中的值  &name=123...
    }
